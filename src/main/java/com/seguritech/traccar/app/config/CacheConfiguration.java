package com.seguritech.traccar.app.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("FrontTraccar");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("FrontTraccar");
        ...
        config.getMapConfigs().put("com.seguritech.traccar.app.domain.*", initializeDomainMapConfig(jHipsterProperties));
